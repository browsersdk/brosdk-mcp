...
public:
   ...
   * On success returns raw diagnostics JSON in *out, not the async callback-style
   * envelope. Caller must release *out with sdk_free(). */
  ...
  virtual int32_t CreateEnv(const char *data, size_t len,
                             char **out, size_t *out_len) const = 0;
   ...
   * On success *out contains the raw backend JSON response. */
  virtual int32_t UpdateEnv(const char *data, size_t len,
                             char **out, size_t *out_len) const = 0;
   ...
   * On success *out contains the raw backend JSON response. */
  virtual int32_t PageEnv(const char *data, size_t len,
                           char **out, size_t *out_len) const = 0;
   ...
   * On success *out contains the raw backend JSON response. */
  virtual int32_t GetEnvInfo(const char *data, size_t len,
                              char **out, size_t *out_len) const = 0;
   ...
   * On success *out contains the raw backend JSON response. */
  virtual int32_t DestroyEnv(const char *data, size_t len,
                              char **out, size_t *out_len) const = 0;
